...
void DrawMenuScreen(void) {
    ...
    DrawText("PROJECT GOLFERO", SCREEN_WIDTH/2 - 220, 60, 50, WHITE);
    DrawText("Choose Game Mode", SCREEN_WIDTH/2 - 120, 140, 24, BLACK);
    
    Vector2 mouse = GetMousePosition();
    
    // Manual button
    Rectangle btn1 = {200, 200, 240, 50};
    bool hover1 = CheckCollisionPointRec(mouse, btn1);
    DrawRectangleRec(btn1, hover1 ? (Color){150, 250, 150, 255} : (Color){100, 200, 100, 255});
    DrawRectangleLinesEx(btn1, 3, BLACK);
    DrawText("Manual Only", 235, 215, 22, BLACK);
    
    // AI Demo button
    Rectangle btn2 = {200, 270, 240, 50};
    bool hover2 = CheckCollisionPointRec(mouse, btn2);
    DrawRectangleRec(btn2, hover2 ? (Color){150, 250, 150, 255} : (Color){100, 200, 100, 255});
    DrawRectangleLinesEx(btn2, 3, BLACK);
    DrawText("AI Demo", 260, 285, 22, BLACK);
    
    // Manual vs AI button
    Rectangle btn3 = {200, 340, 240, 50};
    bool hover3 = CheckCollisionPointRec(mouse, btn3);
    DrawRectangleRec(btn3, hover3 ? (Color){150, 250, 150, 255} : (Color){100, 200, 100, 255});
    DrawRectangleLinesEx(btn3, 3, BLACK);
    DrawText("Manual vs AI", 230, 355, 22, BLACK);
    
    // Quit button
    Rectangle btn4 = {200, 410, 240, 50};
    bool hover4 = CheckCollisionPointRec(mouse, btn4);
    DrawRectangleRec(btn4, hover4 ? (Color){250, 150, 150, 255} : (Color){200, 100, 100, 255});
    DrawRectangleLinesEx(btn4, 3, BLACK);
    DrawText("Quit", 285, 425, 22, BLACK);
